...
public class ProximityManagerAdapter extends ArrayAdapter<ProximityManagerWrapper> {

    public interface RemoveManagerListener {
        void removeManager(ProximityManagerWrapper proximityManager);
    }

    private RemoveManagerListener removeManagerListener;

    public ProximityManagerAdapter(Context context, List<ProximityManagerWrapper> proximityManagerWrappers) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final ProximityManagerWrapper item = getItem(position);
