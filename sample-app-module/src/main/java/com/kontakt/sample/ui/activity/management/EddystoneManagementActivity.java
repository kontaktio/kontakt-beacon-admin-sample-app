...
public class EddystoneManagementActivity extends BaseActivity implements KontaktDeviceConnection.ConnectionListener {
  ...
  @InjectView(R.id.namespace_id) Entry namespaceId;
  @InjectView(R.id.instance_id) Entry instanceId;
  @InjectView(R.id.url) Entry url;
  @InjectView(R.id.power_level) Entry powerLevel;
  @InjectView(R.id.battery_level) Entry batteryLevel;
  @InjectView(R.id.manufacturer_name) Entry manufacturerName;
  @InjectView(R.id.firmware_revision) Entry firmwareRevision;
  @InjectView(R.id.hardware_revision) Entry hardwareRevision;
  ...
  @OnClick(R.id.url)
  void overwriteUrl() {
    InputDialogFragment.newInstance("Overwrite", "Url", getString(R.string.ok), new SDKBiConsumer<DialogInterface, String>() {
      @Override
  ...
  void overwriteNamespaceId() {
    InputDialogFragment.newInstance("Overwrite", "Namespace ID", getString(R.string.ok), new SDKBiConsumer<DialogInterface, String>() {
      @Override
      public void accept(DialogInterface dialogInterface, String result) {
  ...
  void overwriteInstanceId() {
    InputDialogFragment.newInstance("Overwrite", "Instance ID", getString(R.string.ok), new SDKBiConsumer<DialogInterface, String>() {
      @Override
      public void accept(DialogInterface dialogInterface, String result) {
