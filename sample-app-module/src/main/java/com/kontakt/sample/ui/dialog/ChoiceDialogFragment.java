...
public class ChoiceDialogFragment extends AppCompatDialogFragment {
  ...
  public static ChoiceDialogFragment newInstance(final String title, final String message,
      final DialogInterface.OnClickListener positiveOnClickListener) {
    return newInstance(title, message, positiveOnClickListener, defaultNegativeOnClickListener);
  }

  public static ChoiceDialogFragment newInstance(final String title, final String message,
      final DialogInterface.OnClickListener positiveOnClickListener, final DialogInterface.OnClickListener negativeOnClickListener) {
