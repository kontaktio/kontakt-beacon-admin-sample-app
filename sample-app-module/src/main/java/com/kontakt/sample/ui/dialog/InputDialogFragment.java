...
public class InputDialogFragment extends AppCompatDialogFragment {
  ...
  public static InputDialogFragment newInstance(final String title, final String message, final String buttonText,
  ...
  public static InputDialogFragment newInstance(final String title, final String message, final String buttonText, final Drawable icon,
      final SDKBiConsumer<DialogInterface, String> submitBiConsumer) {
  ...
  public AppCompatDialog onCreateDialog(Bundle savedInstanceState) {
    ...
    return new AlertDialog.Builder(getActivity()).setTitle(arguments.getString(TITLE_TAG))
        .setIcon(icon)
        .setView(view)
