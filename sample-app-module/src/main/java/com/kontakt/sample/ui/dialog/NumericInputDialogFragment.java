...
public class NumericInputDialogFragment extends InputDialogFragment {
  ...
  public static NumericInputDialogFragment newInstance(final String title, final String message, final String buttonText,
      final SDKPredicate<Integer> valuePredicate, final SDKBiConsumer submitBiConsumer) {
