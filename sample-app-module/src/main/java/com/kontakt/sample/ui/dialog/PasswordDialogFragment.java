...
public class PasswordDialogFragment extends InputDialogFragment {
  ...
  public static PasswordDialogFragment newInstance(final String title, final String message, final String buttonText,
  ...
  public static PasswordDialogFragment newInstance(final String title, final String message, final String buttonText, final Drawable icon,
      final SDKBiConsumer<DialogInterface, String> submitBiConsumer) {
