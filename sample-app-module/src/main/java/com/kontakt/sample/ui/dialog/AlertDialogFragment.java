...
public class AlertDialogFragment extends DialogFragment {
  ...
  public static AlertDialogFragment newInstance(final String title, final String message, final Drawable icon,
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    return new AlertDialog.Builder(getActivity()).setMessage(arguments.getString(MESSAGE_TAG))
